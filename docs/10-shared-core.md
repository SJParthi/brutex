...
accumulating. It measures 1664 bytes today, so the assertion has 128 bytes of slack
and is a live guard rather than a rounded-up number that could never fire.
